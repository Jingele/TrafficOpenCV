...
\section{System Design}
	...
	\subfigure[background model]{\includegraphics[width=0.22\linewidth]{InitBackgroudFile.jpg}}	
	\subfigure[subtract background from frame image ]{
	\includegraphics[width=0.22\linewidth]{rawMask.jpg} }
