...
\section{System Design}
	...
	\includegraphics[width=0.45\linewidth]{origin.jpg}}
	\subfigure[64 bits float image]{
	\includegraphics[width=0.45\linewidth]{64FC3.jpg}}
	\subfigure[64 bits float image with single channel]{
	\includegraphics[width=0.45\linewidth]{64FC1.jpg}}
	\subfigure[8 bits unsigned char with single channel]{
	\includegraphics[width=0.45\linewidth]{8UC1.jpg}}
	...
	\includegraphics[width=0.45\linewidth]{guassian.jpg} }
	\subfigure[Binary image]{
	\includegraphics[width=0.45\linewidth]{binary.jpg} }
	\subfigure[Dilation]{
	\includegraphics[width=0.45\linewidth]{dilation.jpg} }
	\subfigure[Erosion]{
	\includegraphics[width=0.45\linewidth]{erosion.jpg} }
	...
	\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{InitBackgroudFile.jpg} 
